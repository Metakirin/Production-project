...
export const isLoadingBigLight = Template.bind({})
isLoadingBigLight.args = {
  isLoading: true,
  articles: [],
  view: ArticleView.BIG
}

export const isLoadingSmallLight = Template.bind({})
isLoadingSmallLight.args = {
  isLoading: true,
  articles: [],
...
export const isLoadingBigSakura = Template.bind({})
isLoadingBigSakura.args = {
  isLoading: true,
  articles: [],
  view: ArticleView.BIG
}
isLoadingBigSakura.decorators = [ThemeDecorator(Theme.SAKURA)]

export const isLoadingSmallSakura = Template.bind({})
isLoadingSmallSakura.args = {
  isLoading: true,
  articles: [],
  view: ArticleView.SMALL
}
isLoadingSmallSakura.decorators = [ThemeDecorator(Theme.SAKURA)]
